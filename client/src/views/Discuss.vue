  ...
  <div class="article-container">
    <main class="article-content">
      <header class="header-container">
        <div class="select_item"><router-link to="/discuss/interact">志愿交流</router-link></div>
        <div class="select_item"><router-link to="/discuss/information">信息动态</router-link></div>
        <div class="select_item"><router-link to="/discuss/elegant">风采展示</router-link></div>
        <div class="select_item"><router-link to="/discuss/team">团队动态</router-link></div>
      </header>
    ...
    <aside class="aside">
      <cookie-card class="aside_item-article-hot">
        <template #title>
          <div class="article-hot-title">热读榜</div>
        </template>
...
onBeforeMount(async () => await getHotArticle());
